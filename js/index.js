...
function btnClick() {
    ...
    var submit = document.querySelector(".submit_ALL")
    ...
    if (a > 0) {
        submit.style = "background: url(/imgs/FBTN.png) no-repeat center;";
        sNOTE.innerHTML = '<p>This person does not exist</p>'
    } else {
        submit.style = "background: url(/imgs/SBTN.png) no-repeat center;";
        sNOTE.innerHTML = ''
    }
